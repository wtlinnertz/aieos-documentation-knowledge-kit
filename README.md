...
This kit governs how user-facing documentation, API references, support knowledge bases, and documentation health are produced, validated, and maintained. It is a cross-cutting kit that operates across multiple layers of the AIEOS system rather than sitting in a single sequential position in the pipeline.
...
3. See `docs/entry-from-rek.md` — boundary briefing for the primary entry point
